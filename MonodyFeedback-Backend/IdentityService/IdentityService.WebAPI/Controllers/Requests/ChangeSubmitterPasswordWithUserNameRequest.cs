...
public record ChangeSubmitterPasswordWithUserNameRequest(string UserName, string CurrentPassword, string NewPassword);

public class ChangeSubmitterPasswordWithUserNameRequestValidator : AbstractValidator<ChangeSubmitterPasswordWithUserNameRequest>
{
    public ChangeSubmitterPasswordWithUserNameRequestValidator()
    {
